...
\section{Pour l'intégration temporelle}
  ...
  \subsection{Méthodes ASIRK}
    ...
    L'idée est alors d'intégrer $g$ implicitement, car la raideur nous l'oblige, et d'intégrer $f$ explicitement, car on peut le faire et qu
    Introduit dans \cite{Zhong1996}.
    Utilisé dans \cite{HuangPerssonZahr2019}.
