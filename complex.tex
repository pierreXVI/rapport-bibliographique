...
\section{Pour la résolution du système linéaire}
  ...
  \subsection{Formulation sans matrice}
    ...
    \subsubsection{Calcul de la jacobienne}
      ...
      \footnote{\LM{ok en structuré, mais dans le cas général, c'est toujours aussi simple?}\PS{Simple non mais tu peux quand même extraire un patern, peut être un peu moins creux que la vraie matrice, mais tu peux. Non ?}}
