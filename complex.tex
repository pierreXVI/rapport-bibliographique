...
\section{Pour la résolution du système linéaire}
  ...
  \subsection{Formulation sans matrice}
    ...
    \subsubsection{Calcul de la jacobienne}
      ...
      On peut calculer une coloration de la jacobienne car on peut en général obtenir son pattern de creusité facilement puisqu'un connaît le schéma de discrétisation du code.
