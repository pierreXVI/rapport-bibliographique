...
\section{Pour l'intégration temporelle}
  ...
  \subsection{Méthodes exponentielles}
    ...
    Ces méthodes d'intégration sont depuis longtemps utilisée pour les problèmes qui concernent ma thèse, comme pour la résolution des équations de Navier-Stokes \cite{EdwardsTuckermanFriesnerEtAl1994}.
