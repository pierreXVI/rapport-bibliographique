...
\section{Améliorations de l’algorithme}
    ...
    \footnote{\PS{Dois-je montrer que GMRES n'est pas linéaire ? Ça ne sort pas d'une référence, mais j'ai la preuve sauf que c'est un peu long. En fait j'ai retrouvé dans mes dossiers à l'ONERA la preuve déjà rédigée en LaTeX}\GP{Perso, je pense que c'est cool de mettre la preuve, mais sans doute en annexe. Qu'en pensez-vous ?}\PS{OK pour l'annexe, donc TODO}}
  ...
  \subsection{Recyclage de l'information}
    ...
    \footnote{\PS{En effet la phrase était bizarre, j'ai du perdre le fil en écrivant mais j'ai corrigé.}}
