...
\section{Améliorations de l’algorithme}
    ...
    \footnote{\PS{Dois-je montrer que GMRES n'est pas linéaire ? Ça ne sort pas d'une référence, mais j'ai la preuve sauf que c'est un peu long.}}
  ...
  \subsection{Augmentation, déflation}
    ...
    Pour corriger ce défaut, on utilise deux techniques : l'augmentation ou la déflation.
