...
\section{Méthodes implicites}
  ...
  \subsection{Méthodes de Runge-Kutta}
    ...
    \subsubsection{Méthodes de Rosenbrock}
      ...
      \footnote{\GP{Tu ne dis pas les conséquences mathématiques d'un tel changement}\PS{Pas non plus dans le texte de référence, je peux cependant remonter à la source pour trouver ça, mais est-ce que c'est pas un peu m'éloigner du sujet ?}\GP{Si Lionel OK, on laisse comme cela...}}
      La méthode est donc :
