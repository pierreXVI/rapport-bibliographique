...
\section{Méthodes implicites}
  ...
  \subsection{Méthodes de Runge-Kutta}
    ...
    \PS{citer Iserles, Arieh (1996), A First Course in the Numerical Analysis of Differential Equations ou enlever.}\GP{Oui, citer !}\PS{Mais j'arrive pas à le trouver. J'ai lu que le résultat du paragraphe est montré dedans mais j'aimerai bien le vérifier avant !}
