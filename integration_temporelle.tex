...
\section{Méthodes explicites}
  ...
  \subsection{Méthodes d'Adams-Bashforth}
    ...
    \paragraph{}
    L'analyse de la stabilité des méthodes d'Adams-Bashforth est plus complexe, \cite{HairerWanner1996} \PS{citer également "Solving ordinary differential equations I: Nonstiff problems"} et ne sera donc pas détaillé ici.
