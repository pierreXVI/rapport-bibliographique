...
\section{Résolution du système linéaire}
	...
	Les méthodes itératives, en revanche, vont produire une suite de valeurs qui converge vers la solution, et dont la précision s'afine le long du calcul ce qui permet à l'utilisateur d'arréter le calcul dès qu'il a atteint une estimation convenable.


	Methodes iteratives\cite{OlshanskiiTyrtyshnikov2014, Saad2003}
	Algebre lineaire threfeten \cite{TrefethenBau1997}
%
% \paragraph{}
