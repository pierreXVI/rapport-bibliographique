...
\section{Résolution du système linéaire}
	...
	\subsection{Système linéaire creux}
		...
		\subsection{Méthodes itératives}
			...
			\paragraph{}
			Les méthodes itératives sont encore aujourd'hui très étudiées dans la communauté des mathématiques appliquées \cite{OlshanskiiTyrtyshnikov2014, Saad2003}.
